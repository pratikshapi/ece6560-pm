...
# substrings_order = ["original_low_contrast.jpg", "gaussian_noise.png", "low_contrast_gaussian_noise_with_gaussian_denoising", "low_contrast_gaussian_noise_with_wavelet_denoising", 
#                     "low_contrast_gaussian_noise_with_perona_malik_f1_denoising", "low_contrast_gaussian_noise_with_perona_malik_f2_denoising"]

substrings_order = ["original_low_contrast", "gaussian_noise.png", "gaussian_denoising", "wavelet_denoising", 
...
for idx, file_path in zip(subplot_idx, ordered_file_paths):
    ...
    # axes[i, j].set_title(os.path.basename(file_path).split('.png')[0], fontsize=8)
...
plt.savefig('low_contrast_gauss_noise_plot.png', dpi=300)
